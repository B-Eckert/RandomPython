eliteTable = [
    ...
    "Horrific: At the start of this unit's turn, everyone within 15ft of them must make a Wisdom saving throw against a CON DC or be frightened of them until the end of their next turn.", 'Hound Master: This unit has a beast or monstrosity of CR/2 that they consider their pet. This monster also has its own modifiers, but may not have minions of its own.',
    ...
    "Lethal: Once per turn with one of its attacks it can cause a bleed effect. When struck by this attack, the target must make a Constitution saving throw DC Str or Dex or take 1d4/2d4/3d4/4d4 slashing damage at the start of their turn. This can be ended with the same DC medicine check as an action or by regaining HP from a healer's kit or potion. Otherwise, this effect ends after a minute.", 'Misty: The area 30ft around the target is always considered lightly obscured and dim light.',
