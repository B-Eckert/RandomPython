...
eliteTable = [
    ...
    'Necromancer: Can use an action to revive a corpse on the field as an undead. Their mental scores become 3, their speed is reduced by 10 and they start at half HP, but are allied to the necromancer. The necromancer cannot do this multiple times on the same corpse.',
    ...
    'Terrifying: Can spend its action/action/bonus action/bonus action to cause all creatures within 20ft of it to make a Wisdom saving throw DC-Cha/Str (Humanoid) or Con/Str/Dex (Monster) or be frightened of the creature for one minute. The creature can re-make the saving throw at the end of their turn. Recharge 6/5-6/5-6/4-6.',
    ...
    'Lore Keeper: Your Intelligence increases by 6. Choose up to 3/4/5/6 cantrips or 1st level/2nd level/3rd level/4th level spells. They can cast each of these once/once/twice/twice per day. They use Intelligence to cast.',
    ...
    'Unstable: Once per turn, when this creature takes damage, it causes a thunderous explosion. Everyone within 5/5/10/10ft of the target must make a DC Con Constitution saving throw or take 1d6/3d6/5d6/7d6 thunder damage. On a failure, they are also pushed back 10ft.',
    ...
    'Hoarder: The creature has access to four randomly-selected consumable items of common/uncommon/rare/very rare rarity. If they use them, are killed with an AOE, or use a free action to empty their bag, they are lost. There is a 50% chance to recover unused consumables after a battle.',
    ...
    "Elemental Affinity: One of the creature's attacks deals an additional 1d6/1d8/2d6/2d8 elemental damage of a random type [1d6] (1: fire, 2: cold, 3: acid, 4: lightning, 5: thunder, 6: choose).",
    'Sorcerous: Your Charisma increases by 6. Choose up to 3/4/5/6 cantrips or 1st level/2nd level/3rd level/4th level spells and 1/1/2/3 metamagic options. They can cast each of these once per day, and they can use each metamagic option once. They use Charisma to cast.'
]
